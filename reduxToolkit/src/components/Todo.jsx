                ...
                {todos.map((todo) => (
                    ...
                    >
                        ...
                        <div className='flex gap-4'>
                            ...
                            <button onClick={() => editId === todo.id ? handleSave(todo.id) : handleEdit(todo.id, todo.text)} >
                                <img className='w-7' src="https://cdn-icons-png.flaticon.com/512/4400/4400549.png" alt="" />
                            </button>
                        </div>
                    </li>
                ))}
